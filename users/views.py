...
def register(request):
    if request.method == 'POST':
        ...
        form = UserRegisterForm()   # zwraca pusty formularz nawet gdy został wypełniony
...
def profile(request):
    if request.method == 'POST':
        u_form = UserUpdateForm(request.POST, instance=request.user)      # instance fill current data
        ...
        u_form = UserUpdateForm(instance=request.user)      # instance fill current data
